...
// ✅ Allowed values for DB constraint + UI
...
export default function AdminOrders() {
  ...
  // ✅ Only send allowed values to satisfy DB check constraint
  ...
  // ✅ alias to satisfy any code paths calling formatDate
